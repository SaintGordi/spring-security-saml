...
public class SelectServiceProviderFilter extends SamlFilter<IdentityProviderService> {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (requestMatcher.matches(request)) {
			...
			HostedIdentityProviderConfiguration configuration = provider.getConfiguration();
	...
	protected String getIdpInitUrl(HttpServletRequest request, AbstractExternalProviderConfiguration p)
